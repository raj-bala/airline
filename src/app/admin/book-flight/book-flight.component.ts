...
import { FormArray, Validators, FormGroup, FormControl, FormBuilder } from '../../../../node_modules/@angular/forms';
import { Flights } from '../classes/flight';
import { BookFlight } from '../../home/classes/bookFlight';
...
backToSearchPage() {
  ...
  this.route.navigateByUrl('/login', { skipLocationChange: true }).then(() => {
    this.route.navigate(['/admin/bookFlight']);
  });
}
showSeats() {
  this.display = true;
